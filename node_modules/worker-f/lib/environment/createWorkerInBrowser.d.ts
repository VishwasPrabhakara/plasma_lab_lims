 ...
 */
export default function createWorkerInBrowser<OutputData>(javascriptCode: string, getFromCache: () => CacheValue | undefined, setInCache: (value: CacheValue) => void, onError: (error: unknown) => void, onOutput: (output: OutputData) => void): EnvironmentWorker;
